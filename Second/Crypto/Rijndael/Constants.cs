...
namespace CryptographyLabs.Crypto.Rijndael
{
	public static partial class Rijndael
	{
		...
		private static readonly byte[][] _mixColumnMatrix =
		{
		...
		private static readonly byte[][] _invMixColumnMatrix =
		{
			new byte[] {14, 11, 13, 9},
			new byte[] {9, 14, 11, 13},
			new byte[] {13, 9, 14, 11},
		...
		public static IReadOnlyList<byte> SBox => _sBox;
		public static IReadOnlyList<byte> InvSBox => _invSBox;
	}
}