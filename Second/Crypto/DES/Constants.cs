namespace CryptographyLabs.Crypto
{
	...
	{
		// for keys generation
		private static readonly ulong[] _C0PermMasks =
		{
			0x500050005000500,
			0x303000003030000,
			0x308070D020C0300,
		...
		private static readonly ulong[] _D0PermMasks =
		{
			0x5000500054005400,
			0x3030000031320000,
			0x5080304060A0300,
		...
		private static readonly byte[] _cycleShiftsCount = new byte[16]
		{
			1, 1, 2, 2, 2, 2, 2, 2,
			1, 2, 2, 2, 2, 2, 2, 1
		};

		private static readonly ulong[] _keyFinalPermMasks =
		{
			0x40105400404450,
			0x120001311000,
			0x30C040A060600,
		...
		private static readonly byte[][][] _SBlocks =
		{
			new[]
			{
		...
		private static readonly ulong[] _PPermMasks =
		{
			0x44015150,
			0x13022300,
			0x7010200,
		...
		// for main encr func
		private static readonly ulong[] _IPPermMasks =
		{
			0x5500550055005500,
			0x3333000033330000,
			0xF0F0F0F00000000,
		...
		private static readonly ulong[] _IPInvPermMasks =
		{
			0x5555555500000000,
			0x3300330033003300,
			0xF0F00000F0F0000,
